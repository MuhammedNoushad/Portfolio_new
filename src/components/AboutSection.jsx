      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 ">
            ...
            <p className="text-muted-foreground">
              I'm passionate about delivering user-focused solutions that
              combine clean code with exceptional user experiences.
            </p>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    I enjoy breaking down complex challenges into manageable
                    solutions, always looking for the most efficient and elegant
                    approach
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    technologies and best practices, constantly expanding my
                    skill set
                  </p>
                </div>
              </div>
